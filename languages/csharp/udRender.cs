...
{ 
  ...
  { 
    ...
    public struct udRenderInstance
    {
      ...
      public udRenderInstance(PointCloud.udPointCloud pointCloud, double[] worldMatrix=null)
      {
        if (worldMatrix == null)
    ...
    public class udRenderContext
    {
      ...
      public void Render(udRenderTarget renderView, udRenderInstance[] pModels, int modelCount, udRenderSettings? settings=null)
      {
        ...
        error = udRenderContext_Render(pRenderer, renderView.pRenderTarget, pModels, modelCount, ref defaultSettings);
        udErrorUtils.ThrowOnUnsuccessful(error);
      }
    ...
    public struct udRenderPicking
    {
      ...
      PointCloud.udVoxelID voxelID; //!< The ID of the voxel that was hit by the pick; this ID is only valid for a very short period of time- Do any additional work using this ID this frame.
    };
    ...
    public class udRenderTarget
    {
      ...
      private void GetMatrix(RenderViewMatrix matrixType, double[] cameraMatrix)
      {
